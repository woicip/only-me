<template>
    <button disabled type="submit" class="w-full mt-[10px] py-[8px] flex items-center justify-center rounded-[8px] text-white font-semibold bg-indigo-500 animate-fadeIn">
