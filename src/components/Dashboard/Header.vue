    ...
    <section v-else>
        <div class="header mt-[30px] mobileL:mt-[30px] mobileL:w-full flex items-center justify-between">
            <div class="flex items-center">
                <img v-if="userProfile.avatar.value !== null" :src="userProfile.avatar.value" alt="avatar" class="w-[80px] h-[80px] mobileL:w-[70px] mobileL:h-[70px] rounded-full object-cover">
                ...
                <div class="ml-[20px] mobileL:ml-[20px]">
                    <h1 class="fullname text-lg font-bold mobileL:text-[16px]">{{ userProfile.fullname.value !== null ? userProfile.fullname.value : userProfile.username.value }}</h1>
                    <div class="flex items-center">
                        <p class="username text-white/40 text-sm mobileL:text-[13px]">@{{ userProfile.username.value }}</p>
                        <img v-if="userProfile.verified.value" src="https://img.icons8.com/color/48/000000/verified-badge.png" class="w-[20px] ml-[6px]"/>
                    </div>
                </div>
            </div>
        </div>

        <p v-if="userProfile.bio.value !== null" v-bind:innerHTML="userProfile.bio.value" class="mt-[30px] mobileL:mt-[30px] text-white text-[14px]x mobileL:text-[13px]"></p>
    </section>
</template>