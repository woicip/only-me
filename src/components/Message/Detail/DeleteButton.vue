<script setup>
    ...
    function doAskConfirmRemove(){
        props.handler();
    }
</script>
<template>
    <button class="py-[8px] px-[8px] text-white/25 hover:text-white bg-white/0 hover:bg-red-500/90 rounded-md" @click="doAskConfirmRemove">
